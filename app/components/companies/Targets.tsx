        ...
        >
            ...
            >
              {targets.map((target, index) => (
                <MenuItem value={index} key={index}>
                  {target.target} for {target.target_year} (scope {target.scope})
                </MenuItem>
              ))}
            </Select>
          </FormControl>
              ...
              <Box mr={4}>
                ...
                >
                  ...
                  <Typography fontSize='1.1em' fontWeight={600}>
                    {targets[visibleTarget].base_year}
                  </Typography>
                </Box>
                <Box
                  sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}
                >
                  ...
                  <Typography fontSize='1.1em' fontWeight={600}>
                    {targets[visibleTarget].target_year}
                  </Typography>
                </Box>
                <Box
                  sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}
                >
                  ...
                  <Typography fontSize='1.1em' fontWeight={600}>
                    {targets[visibleTarget].target_value}
                  </Typography>
                </Box>
                <Box
                  sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}
                >
                  ...
                  <Typography fontSize='1.1em' fontWeight={600}>
                    &nbsp;{targets[visibleTarget].target_classification}
                  </Typography>
                </Box>
              </Box>
            )}
          ...
          <Box sx={{ flex: 1, marginTop: { xs: '10px', lg: 0 }, px: 2 }}>
            <Typography fontSize='1em'>
              Source:{' '}
              <NextMUILink sx={{ color: COLORS.WHITE }} href='https://sciencebasedtargets.org/'>
