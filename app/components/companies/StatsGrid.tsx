  ...
  return (
    <Box sx={{ flexGrow: 1 }} pb={3}>
      <Grid container spacing={4}>
        ...
        <StatsBlock
          value={formatAmount(emission?.total_reported_emission_scope_1_2_3)}
          description='Emissions (ton CO₂e)'
        />
        <StatsBlock value={formatAmount(emission?.revenue)} description='Revenue (M USD)' />
        <StatsBlock
          value={formatAmount(emission?.emission_intensity)}
          description='Intensity (t CO₂e / M USD)'
        />
      </Grid>
    </Box>
  );
