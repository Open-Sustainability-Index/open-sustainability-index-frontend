...
const Footer = (): React.ReactElement => {
  return (
    <ThemeProvider theme={footerTheme}>
      <Box sx={{ backgroundColor: COLORS.BLUE_MEDIUM, color: COLORS.BLUE_LIGHT_ALT, px: 3, py: 10, textAlign: { sm: 'left', xs: 'center' } }}>
        ...
        <Typography variant='caption' display='block' gutterBottom sx={{ textAlign: 'center', marginTop: '2em', color: COLORS.BLUE_LIGHT_ALT }}>
